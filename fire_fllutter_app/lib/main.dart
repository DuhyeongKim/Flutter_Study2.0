...
class GuestBookMessage {
  GuestBookMessage({required this.name, required this.message, required dateTime});
  final String name;
    ...
    return Column(
      ...
      children: [
        ...
        for (var message in widget.messages)
          Paragraph1('${message.name}: ${message.message}\n${message.dateTime}', Icon(Icons.delete_outline)),
